...
#### 5. POST: Добавить пакет данных с сенсора
* URL: /sensor_data/batch

Тело запроса:

```json
{
  "internal_id": "your_sensor_id",
  "entries": [
    {
      "timestamp": "2025-04-06T12:00:00Z",
      "is_light": true,
    ...
    {
      "timestamp": "2025-04-06T12:50:00Z",
      "is_light": true,
      "latitude": 40.7129,
      "longitude": -74.0062
    }
...
Ответ:
```json
{"status": "Sensor data added"}
```

#### 6. GET: Получить данные о версиях сенсоров
* URL: /sensor_versions
...
```
#### 7. GET: Получить данные о сенсорах
* URL: /sensors
...
#### 8. GET: Получить данные о птицах
* URL: /birds
...
#### 9. GET: Получить данные с сенсора
* URL: /sensor_data
